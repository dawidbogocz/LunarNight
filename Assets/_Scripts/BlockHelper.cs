...
public static class BlockHelper 
{
	...
	public static Vector2Int TexturePos(Direction direction, BlockType blockType)
	{
	...
	public static Vector2[] FaceUVs(Direction direction, BlockType blockType)
	{
		...
		var tilePos = TexturePos(direction, blockType);
	...
	public static void GetFaceVertices(Direction direction, int x, int y, int z, MeshData meshData, BlockType blockType)
	{
		...
		switch (direction)
		{
			case Direction.backwards:
				MeshGenerator.AddVertex(meshData, new Vector3(x - 0.5f, y - 0.5f, z - 0.5f), generatesCollider);
				MeshGenerator.AddVertex(meshData, new Vector3(x - 0.5f, y + 0.5f, z - 0.5f), generatesCollider);
				MeshGenerator.AddVertex(meshData, new Vector3(x + 0.5f, y + 0.5f, z - 0.5f), generatesCollider);
				MeshGenerator.AddVertex(meshData, new Vector3(x + 0.5f, y - 0.5f, z - 0.5f), generatesCollider);
				break;
	...
	public static MeshData GetFaceDataIn(Direction direction, ChunkData chunk, int x, int y, int z, MeshData meshData, BlockType blockType)
	{
		...
		MeshGenerator.AddQuadTriangles(meshData, BlockDataManager.blockTextureDataDictionary[blockType].generatesCollider);
